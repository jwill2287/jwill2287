        ...
        while numIndex <= maxDrawn:
            ...
            if bingo != 1:
                ...
                if bingo == 1:
                    ...
                    #checks if the current board took more numbers drawn to achieve bingo than the prior board and stores the board values with the X's and the number of numbers drawn to achieve bingo
